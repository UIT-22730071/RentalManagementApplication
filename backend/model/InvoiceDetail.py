class InvoiceDetail:
    def __init__(self,
                 ...
                 rent_price,                  # Giá thuê phòng (VNĐ/tháng) ==> truy cập phòng lấy không cần thiết
                 electricity_price,           # Đơn giá điện (VNĐ/kWh) ==> truy cập phòng lấy không cần thiết
                 water_price,                 # Đơn giá nước (VNĐ/người hoặc m³) ==> truy cập phòng lấy không cần thiết
